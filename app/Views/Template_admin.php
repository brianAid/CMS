...
<head>
  ...
  <title><?= $this->renderSection('judul_halaman') ?></title>
  ...
  <!-- Page CSS -->
  <script src="https://cdn.tiny.cloud/1/hr96sqerw1q4zuulq5akypmuq36onn6km07qt20ltrcofoeo/tinymce/7/tinymce.min.js"
    referrerpolicy="origin"></script>
  <link rel="stylesheet" type="text/css" id="mce-u0" crossorigin="anonymous" referrerpolicy="origin"
    href="https://cdn.tiny.cloud/1/hr96sqerw1q4zuulq5akypmuq36onn6km07qt20ltrcofoeo/tinymce/7.5.1-116/skins/ui/oxide-dark/skin.min.css">
...
<body>
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item <?= (current_url() == base_url('admin/caraousel')) ? 'active' : ''; ?>">
          ...
          <!-- Tables -->
          <li class="menu-item <?= (current_url() == base_url('admin/kategori')) ? 'active' : ''; ?>">
            <a href="<?= base_url('admin/kategori') ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-book"></i>
              <div data-i18n="Tables">Kategori Konten</div>
            </a>
          </li>
          <li class="menu-item <?= (current_url() == base_url('admin/konten')) ? 'active' : ''; ?>">
          ...
          <?php if (session()->get('role') === 'Admin') { ?>
            <li class="menu-item <?= (current_url() == base_url('admin/user')) ? 'active' : ''; ?>">
          ...
          <?php } ?>
          <li class="menu-item <?= (current_url() == base_url('admin/konfigurasi')) ? 'active' : ''; ?>">
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              <div class="nav-item d-flex align-items-left">
                <?= $this->renderSection('judul_halaman') ?>
              </div>
              ...
              <?php if (!empty(session()->getFlashdata('errors'))): ?>
                <?php foreach (session()->getFlashdata('errors') as $field => $error): ?>
                  <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                    <strong><?= ucfirst($field) ?>:</strong> <?= esc($error) ?>
                  </div>
                <?php endforeach ?>
              <?php endif ?>
  ...
  <!-- modal -->
  <script src="<?= base_url('assets/sneat') ?>/assets/js/ui-modals.js">
  </script>

  <!-- toast -->
  <script src="<?= base_url('assets/sneat') ?>/assets/js/ui-toasts.js">
  </script>
